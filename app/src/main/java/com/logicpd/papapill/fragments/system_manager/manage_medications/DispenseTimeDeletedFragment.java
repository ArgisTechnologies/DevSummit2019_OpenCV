 ...
 * @author alankilloren
 */
public class DispenseTimeDeletedFragment extends Fragment implements View.OnClickListener {

    private static final String SCREEN_NAME = "DispenseTimeDeletedFragment";
    ...
    public void onClick(View v) {
        ...
        if (v == btnDone) {
            ...
            bundle.putString("removeAllFragmentsUpToCurrent", "SelectDeleteDispenseTimeFragment");
            mListener.onButtonClicked(bundle);
        }
    }
}