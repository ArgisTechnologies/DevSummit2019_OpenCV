 ...
 * @author alankilloren
 */
public class MedicationTakenFragment extends Fragment implements View.OnClickListener {

    private static final String SCREEN_NAME = "MedicationTakenFragment";
...
//    boolean isEarlyDispense;
    ...
    public void onClick(View v) {
        ...
        if (v == btnGetMedication) {
            ...
            bundle.putString("removeAllFragmentsUpToCurrent", "GetAsNeededMedicationFragment");
            mListener.onButtonClicked(bundle);
        }
        if (v == btnDone) {
