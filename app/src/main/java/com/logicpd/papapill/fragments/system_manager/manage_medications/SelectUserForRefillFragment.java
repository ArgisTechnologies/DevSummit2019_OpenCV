...
public class SelectUserForRefillFragment extends Fragment implements View.OnClickListener {
    ...
    public SelectUserForRefillFragment() {
        // Required empty public constructor
    }

    public static SelectUserForRefillFragment newInstance() {
        return new SelectUserForRefillFragment();
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        tvTitle.setText("SELECT USER TO REFILL BIN FOR");
    ...
    public void onClick(View v) {
        ...
        if (v == btnUserA) {
            bundle.putString("fragmentName", "SelectRefillMedicationFragment");
