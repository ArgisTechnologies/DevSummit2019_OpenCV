...
public class ConfirmDeleteMedsFragment extends Fragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (v == btnNext) {
            ...
            //TODO go to remove meds - this is to be addressed during Remove Medication workflow review
        }
    }
}
